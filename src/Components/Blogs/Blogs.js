    ...
    return (
        ...
        <div className="p-6 md:w-1/2 lg:w-1/3">
            <div className="shadow-xl  rounded-xl bg-blueGray-50 h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={`data:image/png;base64,${blog?.image.img}`} alt="blog" />
                <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{blog?.title}</h2>
                    {/* <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{title}</h1> */}
                    <p className="mb-3 line-clamp-3">{blog?.content}</p>
                    <div className="flex items-center flex-wrap bg-pink-100 rounded-b-xl">
                        <a className="text-indigo-500 inline-flex inline-flex items-center mt-auto font-semibold text-blue-600 lg:mb-0 hover:text-black md:mb-2 lg:mb-0">READ MORE
