...
const Header = () => {
    return (
        <header className="h-2/4">

            <div className="w-full bg-center bg-cover h-128" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1504384308090-c894fdcc538d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80)' }}>
                <div className="py-48 flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
